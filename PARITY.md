...
1. Extend session recovery/lease management beyond analyst-only retained sessions.
2. Move lead-side adjudication and additional orchestration paths onto the same session bridge when isolation is required.
