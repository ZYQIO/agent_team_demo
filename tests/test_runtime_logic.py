...
class RuntimeLogicTests(unittest.TestCase):
    ...
    def test_parse_interactive_plan_command_supports_embedded_lead_prompt(self) -> None:
        ...
        self.assertEqual(
            runtime.parse_interactive_plan_command("status current"),
            {
                "action": "request_current_review_status",
                "raw": "status current",
                "task_id": "",
            },
        )
        self.assertEqual(
            runtime.parse_interactive_plan_command("plan current"),
            {
                "action": "request_current_review_plan",
                "raw": "plan current",
                "task_id": "",
            },
        )
