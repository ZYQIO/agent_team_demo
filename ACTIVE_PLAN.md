...
- the embedded prompt now also lets lead issue teammate follow-on requests against the current review focus with `status current` / `plan current`, further reducing repeated teammate selection while inside one review
